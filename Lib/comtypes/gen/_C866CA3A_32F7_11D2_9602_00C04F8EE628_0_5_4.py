...
__all__ = [
    'DISPID_SGRsDynamic', 'SpeechRetainedAudioOptions',
    'ISpSerializeState', 'SpeechVisemeFeature',
    'DISPID_SPERetainedStreamOffset', 'SAFT22kHz8BitStereo',
    'IEnumSpObjectTokens', 'SPWF_INPUT', 'DISPID_SVAudioOutputStream',
    'DISPID_SDKCreateKey', 'tagSPPROPERTYINFO',
    'SAFT44kHz16BitStereo', 'SAFTDefault', 'ISpeechAudio',
    'DISPID_SPPsItem', 'ISpeechXMLRecoResult', 'SP_VISEME_8',
    'SPCT_DICTATION', 'SDKLDefaultLocation', 'SVP_12',
    'eLEXTYPE_PRIVATE14', 'SVSFParseSsml', 'SITooFast',
    'DISPID_SBSFormat', 'DISPID_SGRInitialState', 'SRAORetainAudio',
    'DISPID_SPRText', 'DISPID_SLPPhoneIds', 'SPEI_MIN_TTS',
    'SPEI_INTERFERENCE', 'DISPID_SPEDisplayAttributes',
    'SVSFNLPSpeakPunc', 'ISpeechTextSelectionInformation',
    'DISPID_SVSLastResult', 'SVPNormal', 'DISPID_SRCRecognizer',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRSTsCount', 'SINoSignal',
    'DISPID_SVSInputSentencePosition', 'SPFM_CREATE_ALWAYS',
    'SRESoundStart', 'ISpRecoGrammar2', 'SAFT11kHz8BitMono',
    'DISPID_SOTDisplayUI', 'DISPID_SPILanguageId',
    'DISPID_SPELexicalForm', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVSpeakCompleteEvent', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SpeechPhraseRule', 'DISPID_SLPLangId', 'SPEI_RESERVED2',
    'SPGS_DISABLED', 'DISPID_SpeechGrammarRuleState',
    'SPEI_END_INPUT_STREAM', 'SPPS_RESERVED1', 'DISPID_SPRsItem',
    'SPEI_MIN_SR', 'SPSFunction', 'DISPID_SVWaitUntilDone',
    'SGDSActiveUserDelimited', 'SPWORD', 'SREPrivate',
    'STCRemoteServer', 'ISpeechLexiconWord',
    'DISPID_SpeechMMSysAudio', 'SpeechDiscardType', 'SPAR_High',
    'SPFM_NUM_MODES', 'SpeechTokenContext', 'SECFDefault',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_20',
    'Speech_StreamPos_RealTime', 'ISpeechRecoResultTimes',
    'SVSFVoiceMask', 'DISPID_SVEWord', 'SpeechTokenIdUserLexicon',
    '_ISpeechVoiceEvents', 'SpSharedRecognizer',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechObjectToken',
    'SpeechPropertyLowConfidenceThreshold',
    'SAFTCCITT_ALaw_22kHzMono', 'STCInprocServer',
    'SAFTCCITT_uLaw_44kHzMono', 'STSF_CommonAppData',
    'SPSHT_NotOverriden', 'DISPID_SRAudioInput', 'ISpeechRecoResult2',
    'DISPID_SVRate', 'SpeechAudioFormatType', 'DISPID_SPRuleId',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechCustomStream',
    'SECFIgnoreKanaType', 'DISPID_SpeechPhraseProperty',
    'DISPID_SFSClose', 'SPEI_SENTENCE_BOUNDARY',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_PRIVATE17',
    'DISPID_SLWLangId', 'SPDATAKEYLOCATION', 'SVSFlagsAsync',
    'SPBO_TIME_UNITS', 'SAFTADPCM_22kHzStereo',
    'SpeechCategoryAudioIn', 'SPPS_RESERVED4', 'SpMMAudioIn',
    'ISpeechPhraseRule', 'SPAS_PAUSE', 'DISPID_SpeechXMLRecoResult',
    'SAFT16kHz8BitStereo', 'SPPS_Function', 'DISPID_SPAs_NewEnum',
    'SPINTERFERENCE_LATENCY_WARNING', 'SINoise',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechRecoContextEvents', 'SP_VISEME_13', 'SVP_21',
    'DISPID_SRRAlternates', 'SpeechTokenValueCLSID',
    'SWPUnknownWordUnpronounceable', 'SREAdaptation',
    'DISPID_SASetState', 'SPLO_STATIC', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSTWeight', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE6', 'SPAO_NONE', 'DISPID_SRGState',
    'SPBINARYGRAMMAR', 'SLTApp', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPPs_NewEnum', 'ISpObjectToken', 'ISpeechVoiceStatus',
    'SRTExtendableParse', 'SPEI_VOICE_CHANGE', 'ISpEventSink',
    'DISPID_SPRFirstElement', 'SRERecoOtherContext',
    'DISPID_SVVolume', 'SpeechRecognitionType',
    'SpeechVoiceSpeakFlags', 'SPPS_NotOverriden', 'SPEI_RESERVED1',
    'SGDSActive', 'DISPID_SRSCurrentStreamNumber',
    'SAFT32kHz16BitMono', 'DISPID_SRGRules', 'SPLO_DYNAMIC',
    'SVEPhoneme', 'DISPID_SGRSTRule', 'DISPID_SVEEnginePrivate',
    'SPSVerb', 'SPCT_SLEEP', 'SSSPTRelativeToStart',
    'ISpeechPhraseRules', 'SGSExclusive', 'DISPID_SLAddPronunciation',
    'SpeechCategoryVoices', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTADPCM_8kHzMono', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRECORESULTTIMES', 'DISPID_SAStatus', 'SREStreamStart',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_RESERVED9', 'SWTAdded', 'SpInProcRecoContext',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE9',
    'ISpRecoContext', '_ISpeechRecoContextEvents', 'DISPID_SGRName',
    'DISPID_SPIReplacements', 'SRTReSent', 'DISPID_SGRSTPropertyId',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE19', 'ISpeechLexiconWords', 'SPEI_MAX_SR',
    'DISPID_SGRSTPropertyValue', 'SREStreamEnd',
    'ISpeechGrammarRuleStateTransitions', 'SPPHRASERULE',
    'SPLEXICONTYPE', 'SGRSTTDictation',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_APP', 'SPXRO_SML',
    'SWPKnownWordPronounceable', 'SECNormalConfidence',
    'SPINTERFERENCE_NOISE', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRs_NewEnum', 'DISPID_SPAsItem', 'DISPID_SPPsCount',
    'DISPID_SGRSTType', 'DISPID_SRRTOffsetFromStart',
    'STCInprocHandler', 'SVP_19', 'SpObjectTokenCategory', 'ISpAudio',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPRuleConfidence',
    'DISPID_SRCERequestUI', 'SREPropertyStringChange',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechAudioStatus',
    'SpeechCategoryRecoProfiles', 'SVSFParseMask', 'DISPID_SRStatus',
    'ISpRecoResult', 'SREBookmark', 'DISPID_SOTGetStorageFileName',
    'SVESentenceBoundary', 'ISpRecognizer', 'SRSActiveAlways',
    'SVSFIsXML', 'SWPUnknownWordPronounceable', 'IEnumString',
    'SPCS_ENABLED', 'DISPID_SpeechRecoResult2', 'SP_VISEME_9',
    'DISPID_SDKDeleteValue', 'SFTInput', 'ISpRecoGrammar',
    'SRAInterpreter', 'DISPID_SASCurrentDevicePosition',
    'eLEXTYPE_PRIVATE16', 'eWORDTYPE_ADDED', 'ISpObjectTokenCategory',
    'DISPID_SRCEBookmark', 'SpeechRunState', 'SP_VISEME_2',
    'ISpGrammarBuilder', 'SDKLCurrentUser', 'SPCT_COMMAND',
    'DISPID_SRIsUISupported', 'SAFT32kHz16BitStereo',
    'SAFTGSM610_11kHzMono', 'SPEVENTENUM', 'ISpeechVoice',
    'SpeechRecoProfileProperties', 'SPBO_AHEAD',
    'ISpeechResourceLoader', 'DISPID_SpeechRecognizer',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPXRO_Alternates_SML',
    'SPEI_ADAPTATION', 'SP_VISEME_1', 'DISPID_SpeechPhraseRules',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SOTCGetDataKey',
    'SVEVoiceChange', 'LONG_PTR', 'SGSEnabled', 'SPVPRIORITY',
    'DISPID_SVPause', 'SVSFNLPMask', 'SDA_No_Trailing_Space',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPEAudioTimeOffset',
    'SRERecognition', 'SPPHRASEPROPERTY', 'DISPID_SVVoice',
    'DISPID_SRCERecognition', 'DISPID_SBSWrite', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_uLaw_22kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseBuilder', 'ISpeechMemoryStream',
    'DISPID_SDKSetStringValue', 'SPAUDIOOPTIONS',
    'DISPID_SABIBufferSize', 'DISPID_SpeechLexicon', 'SRSActive',
    'DISPID_SLPs_NewEnum', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechAudioFormat', 'ISpRecognizer2',
    'SpeechVoicePriority', 'SRTEmulated', 'DISPID_SLPSymbolic',
    'DISPIDSPTSI', 'SP_VISEME_3', 'DISPID_SPIGetText',
    'SPEI_PROPERTY_STRING_CHANGE', 'SGRSTTEpsilon',
    'SpeechDictationTopicSpelling', 'SPRST_ACTIVE',
    'DISPID_SVGetAudioOutputs', 'SAFT24kHz16BitStereo',
    'DISPID_SRSetPropertyString', 'DISPID_SGRSTsItem', 'SP_VISEME_0',
    'SPVOICESTATUS', 'SPSEMANTICFORMAT',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVEWordBoundary',
    'DISPID_SDKGetBinaryValue', 'SPSSuppressWord',
    'DISPID_SVSPhonemeId', 'SpPhoneticAlphabetConverter',
    'DISPID_SPEActualConfidence', 'DISPID_SRCEPhraseStart',
    'SAFT48kHz8BitMono', 'SpResourceManager', 'SAFT16kHz16BitStereo',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_PRIVATE10',
    'SpeechDisplayAttributes', 'SVP_7', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'SBOPause',
    'DISPID_SPAStartElementInResult', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRsAdd',
    'SPRECOSTATE', 'SPSMF_UPS', 'SASStop', 'SSFMCreateForWrite',
    'SpeechCategoryAppLexicons', 'DISPID_SRCESoundEnd',
    'DISPID_SRRAudioFormat', 'SPPS_RESERVED3',
    'DISPID_SASFreeBufferSpace', 'SPPARTOFSPEECH', 'SPINTERFERENCE',
    'SPPS_Noncontent', 'DISPID_SPRulesItem',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SWFEExtraData',
    'DISPID_SVStatus', 'SPGS_ENABLED', 'SAFT32kHz8BitStereo',
    'SPFM_OPEN_READONLY', 'DISPID_SRCEInterference',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpPhoneticAlphabetConverter', 'SAFT11kHz16BitStereo',
    'eWORDTYPE_DELETED', 'DISPID_SWFEBitsPerSample',
    'DISPID_SLGetWords', 'SAFT22kHz16BitMono', 'SpeechAudioVolume',
    'ISpPhoneticAlphabetSelection', 'SpeechCategoryAudioOut',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechPhraseProperties',
    'SAFTGSM610_8kHzMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechVoiceEvents', 'SPRECOGNIZERSTATUS',
    'DISPID_SRGSetTextSelection', 'SAFT44kHz8BitMono',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SLPsItem',
    'DISPID_SpeechPhoneConverter', 'SpInprocRecognizer',
    'SPSModifier', 'DISPID_SPEEngineConfidence',
    'DISPID_SPARecoResult', 'eLEXTYPE_PRIVATE18', 'SASRun',
    'SECLowConfidence', 'DISPID_SMSADeviceId',
    'Speech_StreamPos_Asap', 'DISPID_SVSkip', 'DISPID_SGRSTText',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRGDictationSetState',
    'DISPID_SRRAudio', 'SGDSInactive', 'SVP_16',
    'SGLexicalNoSpecialChars', 'SDA_Two_Trailing_Spaces',
    'ISpStreamFormat', 'SAFTADPCM_22kHzMono', 'ISpeechDataKey',
    'SpeechUserTraining', 'SAFTExtendedAudioFormat',
    'DISPID_SGRsItem', 'DISPID_SpeechVoiceEvent', 'SPEI_RECOGNITION',
    'DISPID_SGRAddResource', 'DISPID_SBSRead',
    'SPINTERFERENCE_TOOSLOW', 'SPSERIALIZEDPHRASE', 'SPAS_CLOSED',
    'SDKLCurrentConfig', 'ISpEventSource',
    'SPRST_INACTIVE_WITH_PURGE', 'SPSHT_EMAIL', 'ISpeechMMSysAudio',
    'DISPID_SVEViseme', 'SRAONone', 'DISPID_SRRGetXMLResult',
    'SpFileStream', 'SGRSTTRule', 'SP_VISEME_6',
    'SpUnCompressedLexicon', 'ISpeechFileStream',
    'SpeechWordPronounceable', 'SAFTNoAssignedFormat',
    'SAFT12kHz8BitStereo', 'ISpNotifyTranslator', 'SPSHT_Unknown',
    'ISpRecognizer3', 'SPEI_TTS_BOOKMARK', 'ISpeechRecognizerStatus',
    'SpeechRuleAttributes', 'SpeechEngineConfidence',
    'DISPID_SRSAudioStatus', '_RemotableHandle',
    'SAFTADPCM_44kHzMono', 'SPEI_PHONEME', 'SREPhraseStart',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_RESERVED6',
    'DISPID_SOTRemoveStorageFileName', 'SVP_10', 'SVP_13',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechRecoResult',
    'DISPID_SPACommit', 'ISpeechPhraseInfo', 'DISPID_SRRRecoContext',
    'SPAO_RETAIN_AUDIO', 'ISpeechRecoContext',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechBaseStream', 'SSTTWildcard',
    'DISPID_SRGRecoContext', 'SPEI_SOUND_END', 'DISPID_SRCState',
    'SPBO_PAUSE', 'SpeechDataKeyLocation',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVDisplayUI', 'SASPause',
    'DISPID_SGRsFindRule', 'DISPID_SVPriority', 'SRATopLevel',
    'SRERequestUI', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPPName',
    'DISPID_SpeechGrammarRule', 'SP_VISEME_4', 'DISPID_SMSAMMHandle',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_9',
    'SSFMOpenReadWrite', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechRuleState', 'DISPID_SPIGetDisplayAttributes',
    'SVEEndInputStream', 'SRADefaultToActive',
    'DISPID_SVESentenceBoundary', 'SREPropertyNumChange',
    'DISPID_SpeechBaseStream', 'SP_VISEME_5', 'SpMMAudioEnum',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPGS_EXCLUSIVE', 'SVF_Stressed', 'DISPID_SRCEStartStream',
    'SPRECOCONTEXTSTATUS', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTADPCM_8kHzStereo', 'SAFT48kHz16BitStereo',
    'SPINTERFERENCE_TOOLOUD', 'SP_VISEME_16',
    'SpTextSelectionInformation', 'DISPID_SCSBaseStream',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SITooSlow',
    'IInternetSecurityManager', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechWaveFormatEx', 'SVP_11', 'DISPID_SRSNumberOfActiveRules',
    'SECHighConfidence', 'DISPID_SRCRequestedUIType',
    'SPEI_RESERVED5', 'SP_VISEME_7', 'SP_VISEME_17',
    'SpeechVisemeType', 'DISPID_SpeechVoiceStatus', 'SPPHRASEELEMENT',
    'DISPID_SLWType', 'eLEXTYPE_RESERVED8', 'SAFT11kHz8BitStereo',
    'SPFILEMODE', 'SPEI_HYPOTHESIS', 'DISPID_SpeechMemoryStream',
    'DISPID_SLRemovePronunciation', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVGetAudioInputs', 'ISpeechGrammarRules',
    'SpSharedRecoContext', 'SDTPronunciation', 'SRAExport',
    'SAFT8kHz8BitStereo', 'SPPS_Modifier', 'SDTAlternates',
    'ISpStreamFormatConverter', 'ISpeechPhraseReplacements',
    'DISPID_SDKOpenKey', 'SPEI_SR_AUDIO_LEVEL', 'SPEVENTSOURCEINFO',
    'DISPID_SASCurrentSeekPosition', 'SAFT12kHz16BitMono', 'SVP_17',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseProperties',
    'SpeechLoadOption', 'SAFTADPCM_44kHzStereo', 'DISPID_SGRClear',
    'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE7',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SMSGetData',
    'DISPID_SpeechGrammarRuleStateTransition', 'SGRSTTTextBuffer',
    'SGRSTTWildcard', 'SRTStandard', 'DISPID_SVSInputWordPosition',
    'DISPID_SOTs_NewEnum', 'SAFTCCITT_ALaw_11kHzMono', 'SPFM_CREATE',
    'SGLexical', 'SpeechStreamSeekPositionType', 'SRSInactive',
    'SRSEIsSpeaking', 'DISPID_SGRsCommitAndSave', 'ISpeechRecoResult',
    'SpPhraseInfoBuilder', 'DISPID_SpeechLexiconWords',
    'DISPID_SASNonBlockingIO', 'SAFT24kHz16BitMono', 'SECFIgnoreCase',
    'UINT_PTR', 'SDTLexicalForm', 'SVSFParseSapi',
    'DISPID_SRCCreateGrammar', 'SPEI_SR_BOOKMARK',
    'DISPID_SPRuleParent', 'SVPAlert',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTCategory',
    'DISPID_SRRTLength', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGDictationUnload', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPAPhraseInfo', 'DISPID_SMSALineId',
    'SAFTADPCM_11kHzMono', 'DISPID_SRAudioInputStream',
    'eLEXTYPE_PRIVATE11', 'DISPID_SDKSetBinaryValue',
    'SpeechAudioFormatGUIDWave',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRSpeakAudio', 'SPBO_NONE', 'ISpeechPhraseProperty',
    'DISPID_SPIElements', 'SAFT22kHz8BitMono', 'SPSNoun',
    'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRDisplayUI',
    'DISPID_SVSInputSentenceLength', 'SREFalseRecognition',
    'SpeechGrammarState', 'SpeechWordType', 'STSF_FlagCreate',
    'SPRST_ACTIVE_ALWAYS', 'SPEI_END_SR_STREAM',
    'SAFT48kHz8BitStereo', 'SpeechGrammarWordType',
    'DISPID_SpeechPhraseReplacements', 'SPAUDIOSTATE',
    'DISPID_SVSLastBookmark', 'DISPID_SOTCreateInstance',
    'DISPID_SRCRetainedAudio', 'SECFNoSpecialChars',
    'DISPID_SVSInputWordLength', 'SPFM_OPEN_READWRITE',
    'SpeechAllElements', 'SPVPRI_ALERT', 'SpeechPropertyAdaptationOn',
    'DISPID_SVSLastBookmarkId', 'SPEI_PHRASE_START',
    'DISPID_SGRsCommit', 'DISPID_SRCreateRecoContext',
    'SpPhoneConverter', 'SVP_6', 'DISPID_SRRDiscardResultInfo',
    'SSFMOpenForRead', 'SPCATEGORYTYPE', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPPNumberOfElements', 'DISPID_SPCPhoneToId',
    'DISPID_SRRecognizer', 'DISPID_SLWsCount', 'SDTProperty',
    'DISPID_SRGCmdLoadFromResource', 'DISPIDSPTSI_ActiveOffset',
    'SPGRAMMARWORDTYPE', 'DISPID_SADefaultFormat', 'SRADynamic',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVEStreamEnd',
    'DISPID_SRProfile', 'SRARoot', 'ISpPhrase',
    'SDA_One_Trailing_Space', 'ISpeechCustomStream', 'SPCONTEXTSTATE',
    'SFTSREngine', 'SpeechSpecialTransitionType',
    'SAFT44kHz8BitStereo', 'DISPID_SLGetPronunciations',
    'SPBOOKMARKOPTIONS', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRCEHypothesis', 'SPPS_Noun', 'DISPIDSPTSI_ActiveLength',
    'SDKLLocalMachine', 'DISPID_SPPId',
    'DISPID_SpeechObjectTokenCategory', 'SAFT48kHz16BitMono',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCEventInterests',
    'SpMMAudioOut', 'DISPID_SVEPhoneme', 'SLOStatic',
    'DISPID_SRGetPropertyString', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPGRAMMARSTATE', 'DISPID_SVEBookmark', 'DISPID_SPRuleName',
    'SLTUser', 'SVP_5', 'SRAImport', 'SpeechAddRemoveWord',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioProperties',
    'SpeechMicTraining', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRState',
    'SGDSActiveWithAutoPause', 'SP_VISEME_14', 'DISPID_SOTId',
    'DISPID_SPIRule', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPIEngineId', 'DISPID_SRRTStreamTime',
    'SPDKL_CurrentUser', 'SpeechFormatType',
    'DISPID_SpeechFileStream', 'DISPID_SDKEnumValues', 'ISpLexicon',
    'DISPID_SRCCmdMaxAlternates', 'SDA_Consume_Leading_Spaces',
    'SpeechPartOfSpeech', 'DISPID_SPCIdToPhone', 'SPSTREAMFORMATTYPE',
    'SPEVENT', 'DISPID_SVSpeak', 'SPSHORTCUTTYPE',
    'DISPID_SRGCmdLoadFromFile', 'SITooQuiet', 'SVEBookmark',
    'ISpPhraseAlt', 'SpeechTokenKeyUI', 'STCLocalServer',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFParseAutodetect',
    'SAFT16kHz16BitMono', 'SAFT22kHz16BitStereo',
    'SPTEXTSELECTIONINFO', 'SVSFPersistXML', 'ISpeechObjectToken',
    'SpeechBookmarkOptions', 'eLEXTYPE_PRIVATE3', 'DISPID_SRRTimes',
    'SpeechCategoryRecognizers', 'SVP_4', 'SAFT11kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechPhraseElement', 'SPVISEMES',
    'DISPID_SpeechAudioStatus', 'DISPID_SABIEventBias',
    'DISPID_SVGetProfiles', 'SPRST_INACTIVE',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRCAudioInInterferenceStatus', 'SPWF_SRENGINE',
    'SpNullPhoneConverter', 'SP_VISEME_10', 'SASClosed',
    'SSSPTRelativeToEnd', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SAEventHandle', 'SpeechRegistryLocalMachineRoot',
    'SpStream', 'DISPID_SVEStreamStart', 'SPEI_REQUEST_UI',
    'ISpNotifySink', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SVP_8', 'DISPID_SpeechRecoContext',
    'DISPID_SPIEnginePrivateData', 'SVSFIsNotXML', 'SpMemoryStream',
    'SPWORDTYPE', 'DISPID_SRSClsidEngine',
    'DISPID_SRRSetTextFeedback', 'SPRST_NUM_STATES', 'SDTDisplayText',
    'SPDKL_DefaultLocation', 'DISPID_SVEVoiceChange',
    'SPPS_RESERVED2', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SBONone',
    'DISPID_SOTsItem', 'ISpeechRecoResultDispatch',
    'SGPronounciation', 'DISPID_SPRuleChildren',
    'SpCompressedLexicon', 'DISPID_SLWPronunciations',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCEEndStream',
    'DISPID_SPPConfidence', 'SP_VISEME_15', 'tagSPTEXTSELECTIONINFO',
    'SPRS_ACTIVE', 'SECFIgnoreWidth', 'SpeechCategoryPhoneConverters',
    'SPEI_RECO_STATE_CHANGE', 'SAFT16kHz8BitMono',
    'DISPID_SDKEnumKeys', 'SRTAutopause', 'SpeechRecognizerState',
    'DISPID_SWFEFormatTag', 'DISPID_SPRNumberOfElements',
    'SPPROPERTYINFO', 'DISPID_SPPEngineConfidence',
    'DISPID_SRGCommit', 'DISPID_SOTsCount', 'ISpResourceManager',
    'SVP_15', 'SGRSTTWord', 'SAFT24kHz8BitMono',
    'DISPID_SABufferInfo', 'ISpObjectWithToken',
    'DISPID_SPIAudioSizeBytes', 'SPPS_Interjection',
    'DISPID_SpeechRecoResultTimes', 'SpeechRecoEvents',
    'SPSERIALIZEDRESULT', 'SPDKL_LocalMachine', 'SPPS_SuppressWord',
    'SPAS_RUN', 'DISPID_SPAsCount', 'DISPID_SRGCmdSetRuleIdState',
    'SPRS_INACTIVE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGCmdSetRuleState', 'SPSLMA', 'SPAUDIOSTATUS',
    'ISpShortcut', 'SAFT8kHz16BitStereo',
    'DISPIDSPTSI_SelectionOffset', 'SPDKL_CurrentConfig',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRSetPropertyNumber',
    'SVP_2', 'eLEXTYPE_PRIVATE4', 'SpObjectToken', 'SVF_None',
    'STSF_AppData', 'SVP_3', 'DISPID_SOTRemove', 'ISpStream',
    'SPWT_PRONUNCIATION', 'DISPID_SLGetGenerationChange',
    'ISpeechPhraseAlternates', 'SpLexicon', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SGRSTPropertyName', 'DISPID_SLWsItem', 'DISPID_SPCLangId',
    'ISpeechGrammarRule', 'DISPID_SpeechPhraseReplacement',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_SOUND_START', 'SpAudioFormat', 'SpCustomStream',
    'SpeechAudioFormatGUIDText', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPEs_NewEnum', 'SSFMCreate',
    'SpeechPropertyResourceUsage', 'DISPID_SOTSetId',
    'SDTReplacement', 'SVEAllEvents', 'DISPID_SRCEEnginePrivate',
    'SREAudioLevel', 'SPEI_SR_PRIVATE', 'SREInterference',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSAddRuleTransition',
    'SPAR_Medium', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPANumberOfElementsInResult', 'SPWT_LEXICAL',
    'SPINTERFERENCE_NONE', 'SPLOADOPTIONS', 'SPEI_UNDEFINED',
    'SP_VISEME_19', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVGetVoices', 'SSTTTextBuffer', 'DISPID_SDKSetLongValue',
    'SAFTNonStandardFormat', 'SRCS_Enabled',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRIsShared',
    '_SPAUDIOSTATE', 'DISPID_SRRGetXMLErrorInfo',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechPhraseElements',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SMSSetData', 'SPVPRI_NORMAL', 'SDTAudio', 'SVP_1',
    'SPEI_MAX_TTS', 'SREAllEvents', 'Speech_Max_Word_Length',
    'ISpXMLRecoResult', 'DISPID_SDKGetStringValue',
    'DISPID_SLPsCount', 'DISPID_SVIsUISupported',
    'SPSMF_SAPI_PROPERTIES', 'SDTRule', 'SpeechLexiconType',
    'DISPID_SOTGetDescription', 'DISPID_SOTIsUISupported',
    'DISPID_SGRSRule', 'DISPID_SRGetRecognizers',
    'SpeechRegistryUserRoot', 'SAFT12kHz16BitStereo',
    'SRSInactiveWithPurge', 'SPAR_Low', 'ISpVoice', 'SP_VISEME_18',
    'DISPID_SPRsCount', 'DISPID_SLWs_NewEnum', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRSTransitions', 'DISPID_SGRAddState',
    'DISPID_SPPChildren', 'SpeechEngineProperties', 'DISPID_SRCVoice',
    'SPWORDLIST', 'SSTTDictation', 'DISPID_SRCESoundStart',
    'DISPID_SRRPhraseInfo', 'SPPHRASE', 'DISPID_SVSVisemeId',
    'DISPID_SABIMinNotification', 'ISpeechPhraseElements',
    'DISPID_SRRTTickCount', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechPropertyResponseSpeed',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPPS_LMA',
    'DISPID_SLGenerationId', 'DISPID_SRCEAdaptation',
    'DISPID_SRCPause', 'SVF_Emphasis', 'SP_VISEME_12',
    'SPEI_RECO_OTHER_CONTEXT', 'SP_VISEME_20', 'SAFTGSM610_22kHzMono',
    'SVP_18', 'DISPID_SLPType', 'Speech_Default_Weight',
    'DISPID_SAFType', 'SPEI_RESERVED3', 'SPWAVEFORMATTYPE',
    'DISPID_SVEventInterests', 'SPAR_Unknown',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSNotOverriden',
    'ISpeechPhraseReplacement', 'DISPID_SOTCDefault',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPIStartTime',
    'DISPID_SPPParent', 'eLEXTYPE_USER', 'SpeechGrammarTagDictation',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechDataKey',
    'DISPID_SRGIsPronounceable', 'SVSFIsFilename', 'SRSEDone',
    'DISPID_SVAudioOutput', 'DISPID_SRGetFormat', 'eLEXTYPE_PRIVATE5',
    'ISpPhoneConverter', 'ISpRecoCategory', 'SAFTGSM610_44kHzMono',
    'DISPID_SRCEFalseRecognition', 'SpeechStreamFileMode',
    'DISPID_SGRSAddWordTransition', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPEsCount', 'eLEXTYPE_PRIVATE12', 'ISpeechAudioFormat',
    'DISPID_SPRules_NewEnum', 'SREStateChange',
    'SpeechGrammarTagWildcard', 'SPRULESTATE',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SOTGetAttribute',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechLexiconPronunciations',
    'DISPID_SRGId', 'DISPID_SPRulesCount', 'IStream', 'SVP_0',
    'SPSHT_OTHER', 'STCAll', 'DISPID_SLWWord',
    'DISPID_SVSRunningState', 'eLEXTYPE_PRIVATE2', 'SpeechAudioState',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE1', 'SREHypothesis', 'SLODynamic',
    'DISPID_SpeechAudioBufferInfo', 'ISpMMSysAudio',
    'DISPID_SRGCmdLoadFromObject', 'SAFT44kHz16BitMono',
    'SAFT8kHz8BitMono', 'SAFT24kHz8BitStereo', 'SAFT32kHz8BitMono',
    'SPPS_Verb', 'ISpeechRecoGrammar', 'SP_VISEME_21', 'SVEViseme',
    'ISpeechAudioBufferInfo', 'ISpeechObjectTokenCategory',
    'ISpeechLexicon', 'eLEXTYPE_RESERVED4', 'SVP_14',
    'STSF_LocalAppData', 'DISPID_SPRuleFirstElement',
    'SpStreamFormatConverter', 'SPVPRI_OVER', 'DISPID_SGRSTNextState',
    'DISPID_SpeechLexiconProns', 'DISPID_SPEPronunciation',
    'SpeechInterference', 'ISpRecoContext2', 'DISPID_SDKGetlongValue',
    'DISPID_SREmulateRecognition', 'ISpeechGrammarRuleState',
    'SpeechTokenShellFolder', 'SpeechRecoContextState',
    'SVEStartInputStream', 'DISPID_SGRAttributes',
    'SPADAPTATIONRELEVANCE', 'SpeechTokenKeyAttributes',
    'DISPID_SRCResume', 'SPWORDPRONOUNCEABLE', 'DISPID_SOTDataKey',
    'DISPID_SRCERecognizerStateChange', 'SPAS_STOP', 'DISPID_SGRId',
    'DISPID_SpeechObjectTokens', 'DISPID_SAFGuid', 'DISPID_SVResume',
    'DISPID_SVEAudioLevel', 'SpVoice', 'SINone',
    'DISPID_SRCEAudioLevel', 'ISpNotifySource', 'DISPID_SRCBookmark',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRDisplayAttributes',
    'tagSTATSTG', 'SPWORDPRONUNCIATION', 'SWTDeleted', 'SPPS_Unknown',
    'DISPID_SABufferNotifySize', 'DISPIDSPRG', 'SVEPrivate',
    'ISpeechPhraseElement', 'SVPOver', 'WAVEFORMATEX',
    'DISPID_SpeechVoice', 'DISPID_SPEAudioStreamOffset',
    'SPWT_DISPLAY', 'SGSDisabled', 'DISPID_SPIProperties',
    'DISPID_SpeechPhraseAlternates',
    'SpeechGrammarRuleStateTransitionType', 'SAFT12kHz8BitMono',
    'DISPID_SASState', 'DISPID_SOTCId', 'DISPID_SBSSeek',
    'ISpeechLexiconPronunciation', 'SAFTText', 'SPSHORTCUTPAIR',
    'DISPID_SPRuleNumberOfElements', 'SpShortcut',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTCCITT_ALaw_22kHzStereo', 'eLEXTYPE_RESERVED6',
    'SPEI_TTS_PRIVATE', 'SGDisplay', 'DISPID_SPPFirstElement',
    'ISpProperties', 'SVSFUnusedFlags', 'DISPID_SVAlertBoundary',
    'SVEAudioLevel', 'SRTSMLTimeout', 'DISPID_SOTCSetId',
    'SVSFDefault', 'SAFT8kHz16BitMono', 'SpNotifyTranslator',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE8', 'SPCS_DISABLED',
    'SECFEmulateResult', 'DISPID_SRGReset', 'DISPID_SVSpeakStream',
    'SP_VISEME_11', 'DISPID_SpeechAudio', 'SPRULE',
    'SPAUDIOBUFFERINFO', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGSetWordSequenceData', 'SPSEMANTICERRORINFO',
    'ISequentialStream', 'SPCT_SUB_COMMAND', 'DISPID_SFSOpen',
    'DISPID_SRCVoicePurgeEvent', 'SITooLoud', 'SpeechTokenKeyFiles',
    'DISPID_SRGDictationLoad', 'ISpeechRecognizer',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPEDisplayText',
    '__MIDL_IWinTypes_0009', 'DISPID_SPIGrammarId',
    'DISPID_SAFSetWaveFormatEx', 'ISpDataKey', 'SPCT_SUB_DICTATION',
    'SRESoundEnd', 'DISPID_SRRSaveToMemory', 'DISPID_SPPValue',
    'DISPID_SAVolume', 'DISPID_SRCRetainedAudioFormat',
    'SRCS_Disabled', 'IInternetSecurityMgrSite', 'SpWaveFormatEx',
    'DISPID_SPEsItem', 'SPSUnknown', 'DISPID_SWFEChannels',
    'SPSInterjection', 'SDTAll', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE20', 'DISPID_SGRsCount', 'SPEI_VISEME'
]
